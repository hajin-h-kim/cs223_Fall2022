 ...
 * @return a positive number if l1's latitude is < l2's or if equal
 * and l1's longitude is < l2's; 0 if l1 and l2 have equal coordinates
 * (which is not the same as are the same point); 1 otherwise
 */
 ...
 * @param l1 a pointer to a location, non-NULL
 * @param l2 a pointer to a location, non-NULL
 * @return a positive number of l1's longitude is < l2's or if equal
